...
const localnet: Node = {
    ...
    connection: {
        ...
        url: "http://192.168.20.222:26657",
        //url: "http://192.168.120.186:36657",
        timeout: 2400000
    },
    ...
    name: "mxw",
    airDrop: "venture tail vault prize beauty amateur mechanic illness leave promote change child cool element crane wear napkin casual frown bracket tumble gasp fan betray",
    kyc: {
